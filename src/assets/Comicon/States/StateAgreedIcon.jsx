...
const StateAgreedIcon = ({ height = '100%' }) => (
	...
	>
		{/* Gradient definition */}
		<defs>
			<linearGradient id="Gradient" x1="20" y1="60" x2="60" y2="40" gradientUnits="userSpaceOnUse">
		...
		{/* Outer green circle */}
		<circle cx="50" cy="50" r="48" fill="#0F650E" />

		{/* Inner gradient circle with border */}
		<circle cx="50" cy="50" r="43" fill="url(#Gradient)" stroke="#eeeeee" strokeWidth="3" />
	</svg>
);
