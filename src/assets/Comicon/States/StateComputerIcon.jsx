...
const StateComputerIcon = ({ height = '100%' }) => (
	...
	>
      ...
      c5.333,0,8.533,4.267,8.533,9.6v219.733c0,5.333-4.267,9.6-8.533,9.6H62.933V249.6z"
		...
		{/* Keyboard top */}
		<rect x="166.4" y="262.4" fill="#3A5569" width="168.533" height="61.867" />
      ...
      C397.867,328.533,382.933,317.867,363.733,317.867z"
		...
		{/* Desk surface */}
		<rect y="342.4" fill="#3A5569" width="501.333" height="158.933" />

		{/* Desk details */}
		<g>
			<rect x="268.8" y="375.467" fill="#637888" width="194.133" height="45.867" />
			<rect x="28.8" y="364.8" fill="#637888" width="11.733" height="113.067" />
			<rect x="60.8" y="364.8" fill="#637888" width="11.733" height="113.067" />
			<rect x="91.733" y="364.8" fill="#637888" width="11.733" height="113.067" />
			<rect x="122.667" y="364.8" fill="#637888" width="11.733" height="113.067" />
			<rect x="153.6" y="364.8" fill="#637888" width="11.733" height="113.067" />
		</g>

		{/* Status lights */}
		<circle fill="#F16D6E" cx="225.067" cy="400" r="11.733" />
		<circle fill="#60C3AB" cx="225.067" cy="443.733" r="11.733" />
	</svg>
);
