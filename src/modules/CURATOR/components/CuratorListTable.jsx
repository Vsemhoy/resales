			...
			<div className={'sa-table-box-header'}>
				<div className={'sa-table-box-curators sa-table-box-row'}>
					<div className={'sa-table-box-cell'}>
						<div className={'sa-table-head-on'}>Дата создания</div>
					</div>
					<div className={'sa-table-box-cell'}>
						<div className={'sa-table-head-on'}>Инициатор</div>
					</div>
					<div className={'sa-table-box-cell'}>
						<div className={'sa-table-head-on'}>Компания</div>
					</div>
					<div className={'sa-table-box-cell'}>
						<div className={'sa-table-head-on'}>Действия</div>
					</div>
				</div>
			</div>
