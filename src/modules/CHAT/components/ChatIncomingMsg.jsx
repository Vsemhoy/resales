...
import {
    FileExcelFilled,
    FileExcelOutlined, FileFilled, FileImageFilled,
    FileImageOutlined, FileMarkdownFilled, FileMarkdownOutlined, FileOutlined, FilePdfFilled,
    FilePdfOutlined, FilePptFilled,
    FilePptOutlined, FileTextFilled, FileTextOutlined, FileWordFilled,
    FileWordOutlined, FileZipFilled, FileZipOutlined
