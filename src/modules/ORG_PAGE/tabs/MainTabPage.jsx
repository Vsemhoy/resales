		...
		<div>
			{show && (
				<div className={'sk-omt-stack'} style={{ borderLeft: '4px solid seagreen' }}>
					...
					<OrgPageMainTabDepartSection edit_mode={editMode} />

					<OrgPageMainTabContactinfoSection edit_mode={editMode} />

					<OrgPageMainTabContactsSection edit_mode={editMode} />

					<OrgPageMainTabPayersSection edit_mode={editMode} />
				</div>
			)}
		</div>
	);
