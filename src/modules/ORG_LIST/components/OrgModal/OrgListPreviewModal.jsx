...
const OrgListPreviewModal = (props) => {
		...
		},
		{
			...
			children: (
				<div className="sk-omt-subs">
					<Collapse size={'small'} items={contactItems} />
				</div>
			),
		},
		{
	...
	const navigateToEditor = (ev) => {
		...
		navigate('/orgs/' + orgId + '?tab=' + activeTab, {
			// + "&mode=edit"
		...
		<div className={'sa-special-modal sam-org-modal-entity'}>
			<Flex vertical gap="middle" align="flex-start">
				...
				<Modal
					...
					title={
						<div className={'sa-flex-space'}>
							<div className={'spec-modal-title'}>Паспорт организации ({orgId})</div>
							<div className={'spec-modal-control'}>
								<div
									className={`spec-modal-control-button ${activeTab === 'm' ? 'active' : ''}`}
									onClick={() => {
										handleChangeTab('m');
									}}
								>
								...
								<div
									className={`spec-modal-control-button ${activeTab === 'b' ? 'active' : ''}`}
									onClick={() => {
										handleChangeTab('b');
									}}
								>
								...
								<div
									className={`spec-modal-control-button ${activeTab === 'o' ? 'active' : ''}`}
									onClick={() => {
										handleChangeTab('o');
									}}
								>
								...
								<div
									className={`spec-modal-control-button ${activeTab === 'p' ? 'active' : ''}`}
									onClick={() => {
										handleChangeTab('p');
									}}
								>
								...
								<div
									className={`spec-modal-control-button ${activeTab === 'c' ? 'active' : ''}`}
									onClick={() => {
										handleChangeTab('c');
									}}
								>
								...
								<div
									className={`spec-modal-control-button ${activeTab === 'n' ? 'active' : ''}`}
									onClick={() => {
										handleChangeTab('n');
									}}
								>
								...
								<div
									className={`spec-modal-control-button ${activeTab === 'h' ? 'active' : ''}`}
									onClick={() => {
										handleChangeTab('h');
									}}
								>
								...
								<Tooltip title="Перейти в редактор">
									<div onMouseDown={navigateToEditor}>
										<div
											className={'spec-modal-control-button expander'}
											// onClick={handleClose}
										>
											<BorderOutlined />
										</div>
								...
								<div className={'spec-modal-control-button closer'} onClick={handleClose}>
									<CloseOutlined />
								</div>
							</div>
						</div>
				...
				>
					<div className={'sa-org-modal-body'} style={{ minHeight: '600px' }}>
						...
						<div class={'sa-org-modal-after-filler'}></div>
					</div>
				</Modal>
