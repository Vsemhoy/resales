	...
	return (
		<div className={'sa-org-row-wrapper'}>
			<div className={`sa-org-history-row ${typeClass}`}>
				...
				<div>
					<div className="sa-orghistory-datacell">
						{baseData && <div>{getPath(baseData.path)}</div>}
					</div>
				</div>
				<div>
					<div className="sa-orghistory-datacell">{baseData?.old}</div>
				</div>
				<div>
					<div className="sa-orghistory-datacell">{baseData?.new}</div>
				</div>
				<div>
					<div className="sa-orghistory-datacell">{baseData?.shortUserName}</div>
				</div>
				<div>
					<div className="sa-orghistory-datacell">{typeName}</div>
				</div>
			</div>
		</div>
	);
